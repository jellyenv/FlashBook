...
export default async function HoursPage() {
  const [rules, exceptions] = await Promise.all([fetchRules(), fetchExceptions()]);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Set your standard weekly hours and slot length, then add custom days or
          blackout dates. These drive your public booking calendar.
        </p>
      </div>
